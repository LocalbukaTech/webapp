...
const restaurants = [
  {
    ...
    image: "/images/Image7_Shiro_Lagos.png",
  },
  {
    id: 2,
    ...
    location: "15/17 Majekodunmi Street, Omotayo Street, Ikeja.",
    rating: "4.5(20 Reviews)",
    image: "/images/Image8_Wakame_Resturant.jpg",
  },
  {
    id: 3,
    name: "Teccas Amala",
    location: "15/17 Majekodunmi Street, Omotayo Street, Ikeja.",
    rating: "4.5(20 Reviews)",
    image: "/images/Image9_Teccas_Amala_Resturant.png",
  },
];
        ...
        {restaurants.map((item) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              {/* TOP ROW (Icon, name, green rating) */}
