...
export function BanUserModal({ isOpen, onClose, onBan }: BanUserModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4">
      <div className="bg-white rounded-[24px] p-8 w-full max-w-[500px] shadow-2xl relative animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-[28px] font-bold text-[#1f2937]">Ban User</h2>
          <button 
            onClick={onClose}
        ...
        {/* Body (using the mock text "suspend this user?" here per the image provided) */}
